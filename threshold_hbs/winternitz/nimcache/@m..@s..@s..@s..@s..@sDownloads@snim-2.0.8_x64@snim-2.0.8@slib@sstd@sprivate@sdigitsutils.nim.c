...
{	old = (*result_p0).len;
	if (nimAddInt(old, n_p3, &TM__J7BLF9cgvwzEso7aEL9cCOKw_8)) { raiseOverflow(); goto BeforeRet_;
	};
	...
	setLengthStrV2((&(*result_p0)), ((NI) ((NI)(TM__J7BLF9cgvwzEso7aEL9cCOKw_8))));
...
{nimErr_ = nimErrorFlag();
	...
	next = ((NI)23);
	{
		while (1) {
			...
			if (nimAddInt(index, ((NI16)1), &TM__J7BLF9cgvwzEso7aEL9cCOKw_3)) { raiseOverflow(); goto BeforeRet_;
			};
			...
			if (nimSubInt(next, ((NI)1), &TM__J7BLF9cgvwzEso7aEL9cCOKw_4)) { raiseOverflow(); goto BeforeRet_;
			};
			...
			if (nimSubInt(next, ((NI)2), &TM__J7BLF9cgvwzEso7aEL9cCOKw_5)) { raiseOverflow(); goto BeforeRet_;
			};
...
LA3_: ;
	if (nimSubInt(((NI)24), next, &TM__J7BLF9cgvwzEso7aEL9cCOKw_9)) { raiseOverflow(); goto BeforeRet_;
	};
