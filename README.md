...
Run this command before running demo, tests, and benchmarking

```bash
cd threshold_hbs/winternitz/nimcache/
```

```bash
chmod +x compile_libwinternitz.sh
```

```bash
./compile_libwinternitz.sh
```
...
Run automated benchmarking with:
